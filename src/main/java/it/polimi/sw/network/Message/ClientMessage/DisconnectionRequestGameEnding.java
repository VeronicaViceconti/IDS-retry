 ...
 */
public class DisconnectionRequestGameEnding extends SampleClientMessage {
    /**
     * Constructor for a DisconnectionRequest message.
     *
     * @param lobby The ID of the lobby the message is associated with.
     */
    public DisconnectionRequestGameEnding(int lobby){
        super(TypeMessageClient.DisconnectionRequestGameEnding,lobby,-1);
    }
    /**
