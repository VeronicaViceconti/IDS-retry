...
public class TUITestManuscriptLongX {
    ...
    static Corner corner1=new Corner(null, Resources.FUNGI,1,false,null);
    static Corner corner2=new Corner(null,null,2,true,null);
    static Corner corner3=new Corner(null,null,3,true,null);
    static Corner corner4=new Corner(null,null,4,true,goldCard);
    ...
    static Corner corner4_1=new Corner(null, Resources.FUNGI,1,false,null);
        ...
        static Corner corner4_4=new Corner(null,null,4,true,goldCard);
    ...
    static ResourceCard resourceCard9=new ResourceCard(cornersr4,1,2,"blue",false,false,false,2, Resources.FUNGI);
        ...
        static Corner corneri_3=new Corner(null,Resources.INSECT,3,true,goldCard);
        static Corner corneri_4=new Corner(null,Resources.ANIMAL,4,true,goldCard);
